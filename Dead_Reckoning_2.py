...
def main():
    ...
    # k = 10_000
    print("IAS Project: Dead Reckoning.\n\tBy: Mohammed Khalid.\n\t    S20220020296\n")
    file_name = input("Enter file name: ")
    x_values = []
    y_values = []
    z_values = []

    with open(f"source/{file_name}", mode="r") as in_file, open("result/displacement.csv", mode="w") as out_file:
    ...
    ax.set_title("Team 23 Dead Reckoning.\n\nMohammed Khalid     2024122367\nSuyash Tiwari       2024122369\nSushant             2024122368")
